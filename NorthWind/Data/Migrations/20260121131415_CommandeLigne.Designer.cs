...
namespace Northwind.Data.Migrations
{
    ...
    [Migration("20260121131415_CommandeLigne")]
    partial class CommandeLigne
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Northwind.Entities.Categorie", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Northwind.Entities.Fournisseur", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Northwind.Entities.Territoire", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(20)
                        .IsUnicode(false)
            ...
            modelBuilder.Entity("Client", b =>
                {
                    b.HasOne("Northwind.Entities.Adresse", "Adresse")
                        .WithMany()
            ...
            modelBuilder.Entity("Commande", b =>
                {
                    ...
                    b.HasOne("Northwind.Entities.Employe", "Employe")
                        .WithMany()
                        .HasForeignKey("IdEmploye")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("Livreur", "Livreur")
                        .WithMany()
            ...
            modelBuilder.Entity("LigneCommande", b =>
                {
                    ...
                    b.HasOne("Northwind.Entities.Produit", "Produit")
                        .WithMany()
            ...
            modelBuilder.Entity("Northwind.Entities.Affectation", b =>
                {
                    b.HasOne("Northwind.Entities.Employe", null)
                        .WithMany()
                        .HasForeignKey("IdEmploye")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Northwind.Entities.Territoire", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Northwind.Entities.Employe", b =>
                {
                    b.HasOne("Northwind.Entities.Adresse", "Adresse")
                        .WithOne()
                        .HasForeignKey("Northwind.Entities.Employe", "IdAdresse")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
            ...
            modelBuilder.Entity("Northwind.Entities.Fournisseur", b =>
                {
                    b.HasOne("Northwind.Entities.Adresse", null)
                        .WithMany()
                        .HasForeignKey("IdAdresse")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
            ...
            modelBuilder.Entity("Northwind.Entities.Produit", b =>
                {
                    b.HasOne("Northwind.Entities.Categorie", "Catégorie")
                        .WithMany()
                        .HasForeignKey("IdCategorie")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("Northwind.Entities.Fournisseur", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Northwind.Entities.Territoire", b =>
                {
                    b.HasOne("Northwind.Entities.Region", "Région")
